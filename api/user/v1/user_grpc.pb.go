...
func (c *userClient) GetLoginInfo(ctx context.Context, in *LoginInfoRequest, opts ...grpc.CallOption) (*LoginInfoReply, error) {
	out := new(LoginInfoReply)
	err := c.cc.Invoke(ctx, "/api.user.v1.User/GetLoginInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServer) GetLoginInfo(context.Context, *LoginInfoRequest) (*LoginInfoReply, error) {
...
func _User_GetLoginInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.user.v1.User/GetLoginInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetLoginInfo(ctx, req.(*LoginInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
